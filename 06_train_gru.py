...
RESULTS_DIR = "./results/cnn_gru"
MODEL_PATH = "./results/cnn_gru/best_gru_model.keras"
...
def main():
    ...
    with open(f"{RESULTS_DIR}/gru_config.json", "w") as f:
        json.dump(config, f, indent=4)
        
    print("GRU Training and Evaluation completed successfully!")
